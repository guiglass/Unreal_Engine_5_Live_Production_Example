...
<br><br>
The Sidekick facecap app can be used to add facial capture to any .fbx or metahuman that includes facial blendshapes. Avatars that were built using the APS_SDK and having the FacecalLinker added in APS may be used to stream facecap data to your live production avatars. The default SK_Man avatar includes all 52 ARKit shapes and can be used to stream facecap data from the sidekick to metahumans (using the node setup shown above).
<p align="center">
