...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimGraphNode_APSLiveLinkNode_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n*\n*/" },
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimGraphNode_APSLiveLinkNode_Statics::NewProp_Node_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Public/AnimGraphNode_APSLiveLinkNode.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimGraphNode_APSLiveLinkNode_Statics::NewProp_Node = { "Node", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimGraphNode_APSLiveLinkNode, Node), Z_Construct_UScriptStruct_FAnimNode_APSLiveLinkNode, METADATA_PARAMS(Z_Construct_UClass_UAnimGraphNode_APSLiveLinkNode_Statics::NewProp_Node_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_APSLiveLinkNode_Statics::NewProp_Node_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAnimGraphNode_APSLiveLinkNode_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAnimGraphNode_APSLiveLinkNode_Statics::NewProp_Node,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAnimGraphNode_APSLiveLinkNode_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UAnimGraphNode_APSLiveLinkNode()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAnimGraphNode_APSLiveLinkNode_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAnimGraphNode_APSLiveLinkNode, 2156931403);
