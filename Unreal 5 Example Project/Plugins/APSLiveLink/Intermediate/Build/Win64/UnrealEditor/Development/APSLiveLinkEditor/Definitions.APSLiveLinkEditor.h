...
#define UE_PROJECT_NAME LiveProductionUE5
#define UE_TARGET_NAME LiveProductionUE5Editor
...
#define APSLIVELINKEDITOR_API DLLEXPORT
#define APSLIVELINK_API DLLIMPORT
