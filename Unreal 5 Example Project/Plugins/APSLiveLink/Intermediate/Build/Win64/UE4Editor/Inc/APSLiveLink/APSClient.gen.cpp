...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_APSLiveLink_SyncRates_Hash() { return 3995257654U; }
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAPSClient_GetBlendshapeValues_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAPSClient_GetBlendshapeValues_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APSClient_eventGetBlendshapeValues_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAPSClient_GetBlendshapeValues_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAPSClient_GetBlendshapeValues_Statics::NewProp_ReturnValue_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAPSClient_GetBlendshapeValues_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAPSClient_GetBlendshapeValues_Statics::Function_MetaDataParams[] = {
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAPSClient_SyncAvatarData_Statics::Function_MetaDataParams[] = {
		{ "Category", "APS (Live-Link)" },
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SyncRate_MetaData[];
#endif
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_SyncRate;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAPSClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAPSClient_GetBlendshapeValues, "GetBlendshapeValues" }, // 3032196552
		{ &Z_Construct_UFunction_UAPSClient_SyncAvatarData, "SyncAvatarData" }, // 1312432400
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAPSClient_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAPSClient_Statics::NewProp_IpAddr_MetaData[] = {
		{ "Category", "APS (Live-Link)" },
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAPSClient_Statics::NewProp_IpAddr = { "IpAddr", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAPSClient, IpAddr), METADATA_PARAMS(Z_Construct_UClass_UAPSClient_Statics::NewProp_IpAddr_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAPSClient_Statics::NewProp_IpAddr_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAPSClient_Statics::NewProp_SyncRate_MetaData[] = {
		{ "Category", "APS (Live-Link)" },
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAPSClient_Statics::NewProp_SyncRate = { "SyncRate", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAPSClient, SyncRate), Z_Construct_UEnum_APSLiveLink_SyncRates, METADATA_PARAMS(Z_Construct_UClass_UAPSClient_Statics::NewProp_SyncRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAPSClient_Statics::NewProp_SyncRate_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAPSClient_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAPSClient_Statics::NewProp_IpAddr,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAPSClient_Statics::NewProp_SyncRate,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAPSClient_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UAPSClient()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAPSClient_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAPSClient, 1747939883);
